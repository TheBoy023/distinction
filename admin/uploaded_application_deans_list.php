...
if (isset($_POST['search'])) {
    ...
    $sql = "SELECT * FROM deans_list_students WHERE student_id LIKE '%$search_query%' OR department LIKE '%$search_query%'";
    $result = $conn->query($sql);
}
?>
...
<body>
    ...
    <div class="container">
        <h1>Uploaded Application for Dean's List Students</h1>
        ...
        <div class="search-bar">
            <div style="display: flex; align-items: center; justify-content: center; gap: 10px;">
                ...
                <form action="deans_list_semester.php" method="post" id="semesterForm">
                    <input type="hidden" name="semester" id="semesterInput" value="">
                    <button type="button" class="semester-select">Select Semester
                        <div class="semester-options">
                            <a href="#" class="semester-option" onclick="selectSemester('First Semester')">First Semester</a>
                            <a href="#" class="semester-option" onclick="selectSemester('Second Semester')">Second Semester</a>
                        </div>
                    </button>
                </form>
