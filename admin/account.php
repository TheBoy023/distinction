...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['update_account'])) {
        ...
        $update_sql = "UPDATE admins SET admin_name='$admin_name', email='$email' WHERE admin_department='$adminDepartment'";
    ...
    if (isset($_POST['change_password'])) {
        ...
        if (password_verify($current_password, $admin['password'])) {
            if ($new_password === $confirm_password) {
                ...
                $update_password_sql = "UPDATE admins SET password='$hashed_password' WHERE admin_department='$adminDepartment'";
